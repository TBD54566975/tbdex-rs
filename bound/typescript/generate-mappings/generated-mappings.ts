...
currencyCode: string
  ...
  export const toWASM = (
    obj: BalanceData
  ): wasm.WasmBalanceData => {
    return new wasm.WasmBalanceData(
      obj.currencyCode,obj.available
    )
  }

          
  export const fromWASM = (
    obj: wasm.WasmBalanceData
  ): BalanceData => {
    const result: BalanceData = {
      available: obj.available,currencyCode: obj.currency_code,
    };
  ...
  export const toWASM = (
    ...
    return new wasm.WasmCancelData(
      obj.reason
    )
  }
...
termsUrl?: string
  ...
  export const toWASM = (
    ...
    return new wasm.WasmCancellationDetails(
      obj.enabled,obj.termsUrl,obj.terms
    )
  }
  ...
  export const fromWASM = (
    ...
    const result: CancellationDetails = {
      enabled: obj.enabled,
            ...
            if (obj.terms_url !== undefined) 
              result.termsUrl = obj.terms_url
...
success?: boolean
  ...
  export const toWASM = (
    ...
    return new wasm.WasmCloseData(
      obj.reason,obj.success
    )
  }

          
  export const fromWASM = (
    obj: wasm.WasmCloseData
  ): CloseData => {
  ...
  export const toWASM = (
    obj: Constraints
  ): wasm.WasmConstraints => {
    return new wasm.WasmConstraints(
      obj.fields?.map(Field.toWASM)
    )
  }

          
  export const fromWASM = (
    obj: wasm.WasmConstraints
  ): Constraints => {
...
payout: CreateSelectedPayoutMethod
  ...
  export const toWASM = (
    obj: CreateRfqData
  ): wasm.WasmCreateRfqData => {
    return new wasm.WasmCreateRfqData(
      obj.offeringId,CreateSelectedPayinMethod.toWASM(obj.payin),CreateSelectedPayoutMethod.toWASM(obj.payout),obj.claims
    )
  }

          
  export const fromWASM = (
    obj: wasm.WasmCreateRfqData
  ): CreateRfqData => {
    const result: CreateRfqData = {
      claims: obj.claims,offeringId: obj.offering_id,payin: CreateSelectedPayinMethod.fromWASM(obj.payin),payout: CreateSelectedPayoutMethod.fromWASM(obj.payout),
    };
...
paymentDetails?: any
  ...
  export const toWASM = (
    ...
    return new wasm.WasmCreateSelectedPayinMethod(
      obj.kind,obj.paymentDetails,obj.amount
    )
  }
  ...
  export const fromWASM = (
    ...
    const result: CreateSelectedPayinMethod = {
      amount: obj.amount,kind: obj.kind,
    };
...
url: string
  ...
  export const toWASM = (
    ...
    return new wasm.WasmDid(
      obj.uri,obj.url,obj.method,obj.id,obj.params,obj.path,obj.query,obj.fragment
    )
  }
  ...
  export const fromWASM = (
    ...
    const result: Did = {
      id: obj.id,method: obj.method,uri: obj.uri,url: obj.url,
    };

    
            if (obj.fragment !== undefined) 
              result.fragment = obj.fragment
            if (obj.params !== undefined) 
              result.params = mapToObject(obj.params)
...
verificationMethod: VerificationMethod[]
  ...
  export const toWASM = (
    ...
    return new wasm.WasmDocument(
      obj.id,obj.context,obj.controller,obj.alsoKnownAs,obj.verificationMethod?.map(VerificationMethod.toWASM),obj.authentication,obj.assertionMethod,obj.keyAgreement,obj.capabilityInvocation,obj.capabilityDelegation,obj.service?.map(Service.toWASM)
    )
  }

          
  export const fromWASM = (
    obj: wasm.WasmDocument
  ): Document => {
    const result: Document = {
      id: obj.id,verificationMethod: obj.verification_method?.map(VerificationMethod.fromWASM)
    };

    
            if (obj.also_known_as !== undefined) 
              result.alsoKnownAs = obj.also_known_as
            ...
            if (obj.controller !== undefined) 
              result.controller = obj.controller
...
method?: string
  ...
  export const toWASM = (
    obj: FetchOptions
  ): wasm.WasmFetchOptions => {
    return new wasm.WasmFetchOptions(
  ...
  export const fromWASM = (
    ...
    const result: FetchOptions = {
            ...
            if (obj.headers !== undefined) 
              result.headers = mapToObject(obj.headers)
...
purpose?: string
  ...
  export const toWASM = (
    ...
    return new wasm.WasmField(
      obj.id,obj.name,obj.path,obj.purpose,obj.filter ? Filter.toWASM(obj.filter) : undefined,obj.optional,obj.predicate ? Optionality.toWASM(obj.predicate) : undefined
    )
  }
    ...
    const result: Field = {
      path: obj.path,
            ...
            if (obj.filter !== undefined) 
              result.filter = Filter.fromWASM(obj.filter)
            if (obj.id !== undefined) 
              result.id = obj.id
...
type?: string
  ...
  export const toWASM = (
    ...
    return new wasm.WasmFilter(
      obj.type,obj.pattern,obj.const,obj.contains ? Filter.toWASM(obj.contains) : undefined
    )
  }
  ...
  export const fromWASM = (
    ...
    const result: Filter = {
            ...
            if (obj.const_value !== undefined) 
              result.const = obj.const_value
...
purpose?: string
  ...
  export const toWASM = (
    ...
    return new wasm.WasmInputDescriptor(
      obj.id,obj.name,obj.purpose,Constraints.toWASM(obj.constraints)
    )
  }

          
  export const fromWASM = (
    obj: wasm.WasmInputDescriptor
  ): InputDescriptor => {
    const result: InputDescriptor = {
      constraints: Constraints.fromWASM(obj.constraints),id: obj.id,
    };
...
y?: string
  ...
  export const toWASM = (
    ...
    return new wasm.WasmJwk(
      obj.alg,obj.kty,obj.crv,obj.d,obj.x,obj.y
    )
  }
  ...
  export const fromWASM = (
    ...
    const result: Jwk = {
      crv: obj.crv,kty: obj.kty,x: obj.x,
    };
...
to: string
  ...
  export const toWASM = (
    obj: MessageMetadata
  ): wasm.WasmMessageMetadata => {
    return new wasm.WasmMessageMetadata(
      obj.from,obj.to,obj.kind,obj.id,obj.exchangeId,obj.externalId,obj.protocol,obj.createdAt
    )
  }

          
  export const fromWASM = (
    obj: wasm.WasmMessageMetadata
  ): MessageMetadata => {
    const result: MessageMetadata = {
      createdAt: obj.created_at,exchangeId: obj.exchange_id,from: obj.from,id: obj.id,kind: obj.kind,protocol: obj.protocol,to: obj.to,
    };

    
            if (obj.external_id !== undefined) 
              result.externalId = obj.external_id
...
requiredClaims?: PresentationDefinition
  ...
  export const toWASM = (
    ...
    return new wasm.WasmOfferingData(
      obj.description,obj.payoutUnitsPerPayinUnit,PayinDetails.toWASM(obj.payin),PayoutDetails.toWASM(obj.payout),obj.requiredClaims ? PresentationDefinition.toWASM(obj.requiredClaims) : undefined,CancellationDetails.toWASM(obj.cancellation)
    )
  }

          
  export const fromWASM = (
    obj: wasm.WasmOfferingData
  ): OfferingData => {
    const result: OfferingData = {
      cancellation: CancellationDetails.fromWASM(obj.cancellation),description: obj.description,payin: PayinDetails.fromWASM(obj.payin),payout: PayoutDetails.fromWASM(obj.payout),payoutUnitsPerPayinUnit: obj.payout_units_per_payin_unit,
    };

    
            if (obj.required_claims !== undefined) 
              result.requiredClaims = PresentationDefinition.fromWASM(obj.required_claims)
  ...
  export const toWASM = (
    obj: Optionality
  ): wasm.WasmOptionality => {
    return new wasm.WasmOptionality(
      obj.optionality
    )
  }
...
payout: PaymentInstruction
  ...
  export const toWASM = (
    ...
    return new wasm.WasmOrderInstructionsData(
      PaymentInstruction.toWASM(obj.payin),PaymentInstruction.toWASM(obj.payout)
    )
  }
  ...
  export const fromWASM = (
    ...
    const result: OrderInstructionsData = {
      payin: PaymentInstruction.fromWASM(obj.payin),payout: PaymentInstruction.fromWASM(obj.payout),
    };
...
status: string
  ...
  export const toWASM = (
    obj: OrderStatusData
  ): wasm.WasmOrderStatusData => {
    return new wasm.WasmOrderStatusData(
      obj.status,obj.details
    )
  }

          
  export const fromWASM = (
    obj: wasm.WasmOrderStatusData
  ): OrderStatusData => {
...
min?: string
  ...
  export const toWASM = (
    obj: PayinDetails
  ): wasm.WasmPayinDetails => {
    return new wasm.WasmPayinDetails(
      obj.currencyCode,obj.methods?.map(PayinMethod.toWASM),obj.min,obj.max
    )
  }

          
  export const fromWASM = (
    obj: wasm.WasmPayinDetails
  ): PayinDetails => {
    const result: PayinDetails = {
      currencyCode: obj.currency_code,methods: obj.methods?.map(PayinMethod.fromWASM)
    };
...
requiredPaymentDetails?: any
  ...
  export const toWASM = (
    obj: PayinMethod
  ): wasm.WasmPayinMethod => {
    return new wasm.WasmPayinMethod(
      obj.kind,obj.name,obj.description,obj.group,obj.requiredPaymentDetails,obj.fee,obj.min,obj.max
    )
  }

          
  export const fromWASM = (
    obj: wasm.WasmPayinMethod
  ): PayinMethod => {
...
link?: string
  ...
  export const toWASM = (
    ...
    return new wasm.WasmPaymentInstruction(
      obj.link,obj.instruction
    )
  }
  ...
  export const fromWASM = (
    ...
    const result: PaymentInstruction = {
            ...
            if (obj.instruction !== undefined) 
              result.instruction = obj.instruction
...
min?: string
  ...
  export const toWASM = (
    ...
    return new wasm.WasmPayoutDetails(
      obj.currencyCode,obj.methods?.map(PayoutMethod.toWASM),obj.min,obj.max
    )
  }

          
  export const fromWASM = (
    obj: wasm.WasmPayoutDetails
  ): PayoutDetails => {
    const result: PayoutDetails = {
      currencyCode: obj.currency_code,methods: obj.methods?.map(PayoutMethod.fromWASM)
    };
...
requiredPaymentDetails?: any
  ...
  export const toWASM = (
    obj: PayoutMethod
  ): wasm.WasmPayoutMethod => {
    return new wasm.WasmPayoutMethod(
      obj.kind,BigInt(obj.estimatedSettlementTime),obj.name,obj.description,obj.group,obj.requiredPaymentDetails,obj.fee,obj.min,obj.max
    )
  }

          
  export const fromWASM = (
    obj: wasm.WasmPayoutMethod
  ): PayoutMethod => {
    const result: PayoutMethod = {
      estimatedSettlementTime: Number(obj.estimated_settlement_time),kind: obj.kind,
    };
...
submission_requirements?: SubmissionRequirement[]
  ...
  export const toWASM = (
    ...
    return new wasm.WasmPresentationDefinition(
      obj.id,obj.name,obj.purpose,obj.input_descriptors?.map(InputDescriptor.toWASM),obj.submission_requirements?.map(SubmissionRequirement.toWASM)
    )
  }
  ...
  export const fromWASM = (
    ...
    const result: PresentationDefinition = {
      id: obj.id,input_descriptors: obj.input_descriptors?.map(InputDescriptor.fromWASM)
    };
            ...
            if (obj.submission_requirements !== undefined) 
              result.submission_requirements = obj.submission_requirements?.map(SubmissionRequirement.fromWASM)
  ...
  export const toWASM = (
    ...
    return new wasm.WasmPrivatePaymentDetails(
      obj.paymentDetails
    )
  }
...
payoutUnitsPerPayinUnit: string
  ...
  export const toWASM = (
    ...
    return new wasm.WasmQuoteData(
      obj.expiresAt,obj.payoutUnitsPerPayinUnit,QuoteDetails.toWASM(obj.payin),QuoteDetails.toWASM(obj.payout)
    )
  }

          
  export const fromWASM = (
    obj: wasm.WasmQuoteData
  ): QuoteData => {
    const result: QuoteData = {
      expiresAt: obj.expires_at,payin: QuoteDetails.fromWASM(obj.payin),payout: QuoteDetails.fromWASM(obj.payout),payoutUnitsPerPayinUnit: obj.payout_units_per_payin_unit,
    };
...
total: string
  ...
  export const toWASM = (
    obj: QuoteDetails
  ): wasm.WasmQuoteDetails => {
    return new wasm.WasmQuoteDetails(
      obj.currencyCode,obj.subtotal,obj.total,obj.fee
    )
  }

          
  export const fromWASM = (
    obj: wasm.WasmQuoteDetails
  ): QuoteDetails => {
    const result: QuoteDetails = {
      currencyCode: obj.currency_code,subtotal: obj.subtotal,total: obj.total,
    };
...
updatedAt?: string
  ...
  export const toWASM = (
    ...
    return new wasm.WasmResourceMetadata(
      obj.kind,obj.from,obj.id,obj.protocol,obj.createdAt,obj.updatedAt
    )
  }
  ...
  export const fromWASM = (
    ...
    const result: ResourceMetadata = {
      createdAt: obj.created_at,from: obj.from,id: obj.id,kind: obj.kind,protocol: obj.protocol,
    };
...
statusCode: number
  ...
  export const toWASM = (
    ...
    return new wasm.WasmResponse(
      obj.statusCode,obj.headers,obj.body
    )
  }

          
  export const fromWASM = (
    obj: wasm.WasmResponse
  ): Response => {
    const result: Response = {
      body: obj.body,statusCode: obj.status_code,
    };
...
payout: SelectedPayoutMethod
  ...
  export const toWASM = (
    ...
    return new wasm.WasmRfqData(
      obj.offeringId,SelectedPayinMethod.toWASM(obj.payin),SelectedPayoutMethod.toWASM(obj.payout),obj.claimsHash
    )
  }

          
  export const fromWASM = (
    obj: wasm.WasmRfqData
  ): RfqData => {
    const result: RfqData = {
      offeringId: obj.offering_id,payin: SelectedPayinMethod.fromWASM(obj.payin),payout: SelectedPayoutMethod.fromWASM(obj.payout),
    };

    
            if (obj.claims_hash !== undefined) 
              result.claimsHash = obj.claims_hash
...
salt: string
  ...
  export const toWASM = (
    obj: RfqPrivateData
  ): wasm.WasmRfqPrivateData => {
    return new wasm.WasmRfqPrivateData(
      obj.salt,obj.payin ? PrivatePaymentDetails.toWASM(obj.payin) : undefined,obj.payout ? PrivatePaymentDetails.toWASM(obj.payout) : undefined,obj.claims
    )
  }

          
  export const fromWASM = (
    obj: wasm.WasmRfqPrivateData
  ): RfqPrivateData => {
...
paymentDetailsHash?: string
  ...
  export const toWASM = (
    ...
    return new wasm.WasmSelectedPayinMethod(
      obj.kind,obj.paymentDetailsHash,obj.amount
    )
  }
...
paymentDetailsHash?: string
  ...
  export const toWASM = (
    ...
    return new wasm.WasmSelectedPayoutMethod(
      obj.kind,obj.paymentDetailsHash
    )
  }
...
type: string
  ...
  export const toWASM = (
    ...
    return new wasm.WasmService(
      obj.id,obj.type,obj.serviceEndpoint
    )
  }

          
  export const fromWASM = (
    obj: wasm.WasmService
  ): Service => {
    const result: Service = {
      id: obj.id,serviceEndpoint: obj.service_endpoint,type: obj.type,
    };
...
rule: SubmissionRequirementRule
  ...
  export const toWASM = (
    ...
    return new wasm.WasmSubmissionRequirement(
      SubmissionRequirementRule.toWASM(obj.rule),obj.from,obj.from_nested?.map(SubmissionRequirement.toWASM),obj.name,obj.purpose,obj.count,obj.min,obj.max
    )
  }
  ...
  export const toWASM = (
    ...
    return new wasm.WasmSubmissionRequirementRule(
      obj.rule
    )
  }
...
variant: string
  ...
  export const fromWASM = (
    obj: wasm.WasmTbdexError
  ): TbdexError => {
    const result: TbdexError = {
      isWeb5Error: obj.is_web5_error,message: obj.message,variant: obj.variant,
    };
...
type: string
  ...
  export const toWASM = (
    ...
    return new wasm.WasmVerificationMethod(
      obj.id,obj.type,obj.controller,Jwk.toWASM(obj.publicKeyJwk)
    )
  }
  ...
  export const fromWASM = (
    ...
    const result: VerificationMethod = {
      controller: obj.controller,id: obj.id,publicKeyJwk: Jwk.fromWASM(obj.public_key_jwk),type: obj.type,
    };
