...
internal interface UniffiLib : Library {
    ...
    fun uniffi_tbdex_uniffi_fn_clone_exchange(`ptr`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
    ): Pointer
    fun uniffi_tbdex_uniffi_fn_free_exchange(`ptr`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
    ): Unit
    fun uniffi_tbdex_uniffi_fn_method_exchange_get_data(`ptr`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
    ): RustBuffer.ByValue
    fun uniffi_tbdex_uniffi_fn_method_exchange_to_json(`ptr`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
    ): RustBuffer.ByValue
    ...
    fun uniffi_tbdex_uniffi_checksum_method_exchange_get_data(
    ): Short
    fun uniffi_tbdex_uniffi_checksum_method_exchange_to_json(
    ): Short
...
private fun uniffiCheckApiChecksums(lib: UniffiLib) {
    ...
    if (lib.uniffi_tbdex_uniffi_checksum_func_get_exchange() != 51989.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    ...
    if (lib.uniffi_tbdex_uniffi_checksum_method_exchange_get_data() != 39744.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_tbdex_uniffi_checksum_method_exchange_to_json() != 9318.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
...
open class Exchange: Disposable, AutoCloseable, ExchangeInterface {
    ...
    private class UniffiCleanAction(private val pointer: Pointer?) : Runnable {
        override fun run() {
            pointer?.let { ptr ->
                uniffiRustCall { status ->
                    UniffiLib.INSTANCE.uniffi_tbdex_uniffi_fn_free_exchange(ptr, status)
                }
            }
        }
    }
    ...
    fun uniffiClonePointer(): Pointer {
        return uniffiRustCall() { status ->
            UniffiLib.INSTANCE.uniffi_tbdex_uniffi_fn_clone_exchange(pointer!!, status)
        }
    }

    override fun `getData`(): ExchangeData {
            return FfiConverterTypeExchangeData.lift(
    callWithPointer {
    uniffiRustCall() { _status ->
    UniffiLib.INSTANCE.uniffi_tbdex_uniffi_fn_method_exchange_get_data(
        it, _status)
}
    }
    )
    ...
    callWithPointer {
    uniffiRustCallWithError(RustCoreException) { _status ->
    UniffiLib.INSTANCE.uniffi_tbdex_uniffi_fn_method_exchange_to_json(
        it, _status)
}
    }
    )
...
public object FfiConverterTypeExchange: FfiConverter<Exchange, Pointer> {

    override fun lower(value: Exchange): Pointer {
        return value.uniffiClonePointer()
    }

    override fun lift(value: Pointer): Exchange {
        return Exchange(value)
    }

    override fun read(buf: ByteBuffer): Exchange {
        // The Rust code always writes pointers as 8 bytes, and will
        // fail to compile if they don't fit.
        return lift(Pointer(buf.getLong()))
    }

    override fun allocationSize(value: Exchange) = 8UL

    override fun write(value: Exchange, buf: ByteBuffer) {
        // The Rust code always expects pointers written as 8 bytes,
        // and will fail to compile if they don't fit.
        buf.putLong(Pointer.nativeValue(lower(value)))
    }
...
public object FfiConverterMapStringString: FfiConverterRustBuffer<Map<kotlin.String, kotlin.String>> {
    ...
    @Throws(RustCoreException::class) fun `getExchange`(`pfiDidUri`: kotlin.String, `bearerDid`: BearerDid, `exchangeId`: kotlin.String): Exchange {
            return FfiConverterTypeExchange.lift(
    uniffiRustCallWithError(RustCoreException) { _status ->
