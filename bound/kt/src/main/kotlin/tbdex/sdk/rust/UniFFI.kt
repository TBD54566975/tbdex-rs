...
internal interface UniffiLib : Library {
    ...
    fun uniffi_tbdex_uniffi_fn_clone_httprequestbody(`ptr`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
    ): Pointer
    fun uniffi_tbdex_uniffi_fn_free_httprequestbody(`ptr`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
    ): Unit
    fun uniffi_tbdex_uniffi_fn_constructor_httprequestbody_from_json_string(`json`: RustBuffer.ByValue,uniffi_out_err: UniffiRustCallStatus, 
    ): Pointer
    fun uniffi_tbdex_uniffi_fn_constructor_httprequestbody_new(`jsonSerializedMessage`: RustBuffer.ByValue,`replyTo`: RustBuffer.ByValue,uniffi_out_err: UniffiRustCallStatus, 
    ): Pointer
    fun uniffi_tbdex_uniffi_fn_method_httprequestbody_get_data(`ptr`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
    ): RustBuffer.ByValue
    fun uniffi_tbdex_uniffi_fn_method_httprequestbody_to_json(`ptr`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
    ): RustBuffer.ByValue
    ...
    fun uniffi_tbdex_uniffi_checksum_method_httprequestbody_get_data(
    ): Short
    fun uniffi_tbdex_uniffi_checksum_method_httprequestbody_to_json(
    ): Short
    ...
    fun uniffi_tbdex_uniffi_checksum_constructor_httprequestbody_from_json_string(
    ): Short
    fun uniffi_tbdex_uniffi_checksum_constructor_httprequestbody_new(
    ): Short
...
private fun uniffiCheckApiChecksums(lib: UniffiLib) {
    ...
    if (lib.uniffi_tbdex_uniffi_checksum_method_httprequestbody_get_data() != 31152.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_tbdex_uniffi_checksum_method_httprequestbody_to_json() != 19214.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    ...
    if (lib.uniffi_tbdex_uniffi_checksum_constructor_httprequestbody_from_json_string() != 6428.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_tbdex_uniffi_checksum_constructor_httprequestbody_new() != 20777.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
...
public interface HttpRequestBodyInterface {
    
    fun `getData`(): HttpRequestBodyData
...
open class HttpRequestBody: Disposable, AutoCloseable, HttpRequestBodyInterface {
    ...
    constructor(`jsonSerializedMessage`: kotlin.String, `replyTo`: kotlin.String?) :
        this(
    uniffiRustCallWithError(RustCoreException) { _status ->
    UniffiLib.INSTANCE.uniffi_tbdex_uniffi_fn_constructor_httprequestbody_new(
        FfiConverterString.lower(`jsonSerializedMessage`),FfiConverterOptionalString.lower(`replyTo`),_status)
}
    )
    ...
    private class UniffiCleanAction(private val pointer: Pointer?) : Runnable {
        override fun run() {
            pointer?.let { ptr ->
                uniffiRustCall { status ->
                    UniffiLib.INSTANCE.uniffi_tbdex_uniffi_fn_free_httprequestbody(ptr, status)
                }
            }
        }
    }
    ...
    fun uniffiClonePointer(): Pointer {
        return uniffiRustCall() { status ->
            UniffiLib.INSTANCE.uniffi_tbdex_uniffi_fn_clone_httprequestbody(pointer!!, status)
        }
    }

    
    @Throws(RustCoreException::class)override fun `getData`(): HttpRequestBodyData {
            return FfiConverterTypeHttpRequestBodyData.lift(
    callWithPointer {
    uniffiRustCallWithError(RustCoreException) { _status ->
    UniffiLib.INSTANCE.uniffi_tbdex_uniffi_fn_method_httprequestbody_get_data(
        it, _status)
}
    }
    )
    ...
    callWithPointer {
    uniffiRustCallWithError(RustCoreException) { _status ->
    UniffiLib.INSTANCE.uniffi_tbdex_uniffi_fn_method_httprequestbody_to_json(
        it, _status)
}
    }
    )
    ...
    @Throws(RustCoreException::class) fun `fromJsonString`(`json`: kotlin.String): HttpRequestBody {
            return FfiConverterTypeHttpRequestBody.lift(
    uniffiRustCallWithError(RustCoreException) { _status ->
    UniffiLib.INSTANCE.uniffi_tbdex_uniffi_fn_constructor_httprequestbody_from_json_string(
        FfiConverterString.lower(`json`),_status)
}
    )
    }
...
public object FfiConverterTypeHttpRequestBody: FfiConverter<HttpRequestBody, Pointer> {

    override fun lower(value: HttpRequestBody): Pointer {
        return value.uniffiClonePointer()
    }

    override fun lift(value: Pointer): HttpRequestBody {
        return HttpRequestBody(value)
    }

    override fun read(buf: ByteBuffer): HttpRequestBody {
        // The Rust code always writes pointers as 8 bytes, and will
        // fail to compile if they don't fit.
        return lift(Pointer(buf.getLong()))
    }

    override fun allocationSize(value: HttpRequestBody) = 8UL

    override fun write(value: HttpRequestBody, buf: ByteBuffer) {
        // The Rust code always expects pointers written as 8 bytes,
        // and will fail to compile if they don't fit.
        buf.putLong(Pointer.nativeValue(lower(value)))
    }
...
data class HttpRequestBodyData (
...
public object FfiConverterTypeHttpRequestBodyData: FfiConverterRustBuffer<HttpRequestBodyData> {
    override fun read(buf: ByteBuffer): HttpRequestBodyData {
        return HttpRequestBodyData(
