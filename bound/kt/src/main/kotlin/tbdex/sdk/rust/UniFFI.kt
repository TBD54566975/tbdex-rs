...
internal interface UniffiLib : Library {
    ...
    fun uniffi_tbdex_uniffi_fn_clone_httpbody(`ptr`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
    ): Pointer
    fun uniffi_tbdex_uniffi_fn_free_httpbody(`ptr`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
    ): Unit
    fun uniffi_tbdex_uniffi_fn_constructor_httpbody_from_json_string(`json`: RustBuffer.ByValue,uniffi_out_err: UniffiRustCallStatus, 
    ): Pointer
    fun uniffi_tbdex_uniffi_fn_method_httpbody_get_data(`ptr`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
    ): RustBuffer.ByValue
    ...
    fun uniffi_tbdex_uniffi_checksum_method_httpbody_get_data(
    ): Short
    ...
    fun uniffi_tbdex_uniffi_checksum_constructor_httpbody_from_json_string(
    ): Short
...
private fun uniffiCheckApiChecksums(lib: UniffiLib) {
    ...
    if (lib.uniffi_tbdex_uniffi_checksum_method_httpbody_get_data() != 23089.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    ...
    if (lib.uniffi_tbdex_uniffi_checksum_constructor_httpbody_from_json_string() != 43068.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
...
public interface HttpBodyInterface {
    ...
    fun `getData`(): HttpBodyData
    
    companion object
}

open class HttpBody: Disposable, AutoCloseable, HttpBodyInterface {
    ...
    private class UniffiCleanAction(private val pointer: Pointer?) : Runnable {
        override fun run() {
            pointer?.let { ptr ->
                uniffiRustCall { status ->
                    UniffiLib.INSTANCE.uniffi_tbdex_uniffi_fn_free_httpbody(ptr, status)
                }
            }
        }
    }
    ...
    fun uniffiClonePointer(): Pointer {
        return uniffiRustCall() { status ->
            UniffiLib.INSTANCE.uniffi_tbdex_uniffi_fn_clone_httpbody(pointer!!, status)
        }
    }

    override fun `getData`(): HttpBodyData {
            return FfiConverterTypeHttpBodyData.lift(
    callWithPointer {
    uniffiRustCall() { _status ->
    UniffiLib.INSTANCE.uniffi_tbdex_uniffi_fn_method_httpbody_get_data(
        it, _status)
}
    }
    )
    ...
    @Throws(RustCoreException::class) fun `fromJsonString`(`json`: kotlin.String): HttpBody {
            return FfiConverterTypeHttpBody.lift(
    uniffiRustCallWithError(RustCoreException) { _status ->
    UniffiLib.INSTANCE.uniffi_tbdex_uniffi_fn_constructor_httpbody_from_json_string(
        FfiConverterString.lower(`json`),_status)
}
    )
    }
...
public object FfiConverterTypeHttpBody: FfiConverter<HttpBody, Pointer> {

    override fun lower(value: HttpBody): Pointer {
        return value.uniffiClonePointer()
    }

    override fun lift(value: Pointer): HttpBody {
        return HttpBody(value)
    }

    override fun read(buf: ByteBuffer): HttpBody {
        // The Rust code always writes pointers as 8 bytes, and will
        // fail to compile if they don't fit.
        return lift(Pointer(buf.getLong()))
    }

    override fun allocationSize(value: HttpBody) = 8UL

    override fun write(value: HttpBody, buf: ByteBuffer) {
        // The Rust code always expects pointers written as 8 bytes,
        // and will fail to compile if they don't fit.
        buf.putLong(Pointer.nativeValue(lower(value)))
    }
...
data class HttpBodyData (
    var `message`: HttpBodyMessageData?, 
    var `replyTo`: kotlin.String?
) : Disposable {
...
public object FfiConverterTypeHttpBodyData: FfiConverterRustBuffer<HttpBodyData> {
    override fun read(buf: ByteBuffer): HttpBodyData {
        return HttpBodyData(
            FfiConverterOptionalTypeHttpBodyMessageData.read(buf),
            FfiConverterOptionalString.read(buf),
        )
    }

    override fun allocationSize(value: HttpBodyData) = (
            FfiConverterOptionalTypeHttpBodyMessageData.allocationSize(value.`message`) +
            FfiConverterOptionalString.allocationSize(value.`replyTo`)
    )

    override fun write(value: HttpBodyData, buf: ByteBuffer) {
            FfiConverterOptionalTypeHttpBodyMessageData.write(value.`message`, buf)
            FfiConverterOptionalString.write(value.`replyTo`, buf)
    }
}
...
data class HttpBodyMessageData (
    var `rfq`: Rfq?, 
    var `quote`: Quote?, 
    var `order`: Order?, 
    var `orderStatuses`: List<OrderStatus>?, 
...
public object FfiConverterTypeHttpBodyMessageData: FfiConverterRustBuffer<HttpBodyMessageData> {
    override fun read(buf: ByteBuffer): HttpBodyMessageData {
        return HttpBodyMessageData(
            FfiConverterOptionalTypeRfq.read(buf),
            FfiConverterOptionalTypeQuote.read(buf),
            FfiConverterOptionalTypeOrder.read(buf),
            FfiConverterOptionalSequenceTypeOrderStatus.read(buf),
            FfiConverterOptionalTypeClose.read(buf),
    ...
    override fun allocationSize(value: HttpBodyMessageData) = (
            FfiConverterOptionalTypeRfq.allocationSize(value.`rfq`) +
            FfiConverterOptionalTypeQuote.allocationSize(value.`quote`) +
            FfiConverterOptionalTypeOrder.allocationSize(value.`order`) +
            FfiConverterOptionalSequenceTypeOrderStatus.allocationSize(value.`orderStatuses`) +
            FfiConverterOptionalTypeClose.allocationSize(value.`close`)
    ...
    override fun write(value: HttpBodyMessageData, buf: ByteBuffer) {
            FfiConverterOptionalTypeRfq.write(value.`rfq`, buf)
            FfiConverterOptionalTypeQuote.write(value.`quote`, buf)
            FfiConverterOptionalTypeOrder.write(value.`order`, buf)
            FfiConverterOptionalSequenceTypeOrderStatus.write(value.`orderStatuses`, buf)
            FfiConverterOptionalTypeClose.write(value.`close`, buf)
...
public object FfiConverterOptionalTypeRfq: FfiConverterRustBuffer<Rfq?> {
    override fun read(buf: ByteBuffer): Rfq? {
        if (buf.get().toInt() == 0) {
            return null
        }
        return FfiConverterTypeRfq.read(buf)
    }

    override fun allocationSize(value: Rfq?): ULong {
        if (value == null) {
            return 1UL
        } else {
            return 1UL + FfiConverterTypeRfq.allocationSize(value)
        }
    }
    ...
    override fun write(value: Rfq?, buf: ByteBuffer) {
        if (value == null) {
            ...
            buf.put(1)
            FfiConverterTypeRfq.write(value, buf)
        }
    }
}
...
public object FfiConverterOptionalTypeHttpBodyMessageData: FfiConverterRustBuffer<HttpBodyMessageData?> {
    override fun read(buf: ByteBuffer): HttpBodyMessageData? {
        if (buf.get().toInt() == 0) {
            return null
        }
        return FfiConverterTypeHttpBodyMessageData.read(buf)
    }

    override fun allocationSize(value: HttpBodyMessageData?): ULong {
        if (value == null) {
            return 1UL
        } else {
            return 1UL + FfiConverterTypeHttpBodyMessageData.allocationSize(value)
        }
    }
    ...
    override fun write(value: HttpBodyMessageData?, buf: ByteBuffer) {
        if (value == null) {
            ...
            buf.put(1)
            FfiConverterTypeHttpBodyMessageData.write(value, buf)
        }
    }
}
