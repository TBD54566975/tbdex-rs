    ...
    companion object {
        internal fun fromRustCore(rustCorePayinMethod: RustCorePayinMethod): PayinMethod {
            return PayinMethod(
                ...
                rustCorePayinMethod.jsonSerializedRequiredPaymentDetails?.let { Json.jsonMapper.readTree(it) },
    ...
    companion object {
        internal fun fromRustCore(rustCorePayoutMethod: RustCorePayoutMethod): PayoutMethod {
            return PayoutMethod(
                ...
                rustCorePayoutMethod.jsonSerializedRequiredPaymentDetails?.let { Json.jsonMapper.readTree(it) },
