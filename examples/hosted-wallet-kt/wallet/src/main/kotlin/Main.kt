...
// Set the default flow type here
val FLOW_TYPE = ExchangeFlowType.HAPPY_PATH_FLOW
...
fun main() {
    ...
    when (FLOW_TYPE) {
        ExchangeFlowType.HAPPY_PATH_FLOW -> runHappyPathFlow(pfiDidUri, verifiableCredential, bearerDid, replyToUrl)
