...
// Instantiate BearerDid and OfferingsRepository
// const bearerDid = BearerDid.fromPortableDID(process.env.PFI_PORTABLE_DID);
const offeringsRepository = new OfferingRepository(); // Import OfferingRepository from offerings.ts
await offeringsRepository.signAndVerifyOfferings(bearerDid);

// Inject the offeringsRepository into the routers
